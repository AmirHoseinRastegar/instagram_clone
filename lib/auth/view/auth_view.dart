...
import 'package:instagram_clone/auth/login/view/login_view.dart';
import 'package:instagram_clone/auth/sign_up/view/sign_up_view.dart';
...
class AuthView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PageTransitionSwitcher(
      ...
      child: showLogin ? const LoginView() : const SignUp(),
    );
  }
}
