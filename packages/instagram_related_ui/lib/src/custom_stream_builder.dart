...
class CustomStreamBuilder<T extends Object> extends StatefulWidget {
  ...
  @override
  State<CustomStreamBuilder> createState() => _CustomStreamBuilderState<T>();
}

class _CustomStreamBuilderState<T extends Object>
    extends State<CustomStreamBuilder<T>> {
  T? _lastEvent;
